...
/*===========================================================================*
 *			req_breadwrite					     *  //project3 added as PUBLIC for all methods
 *===========================================================================*/
...
/*===========================================================================*
 *				req_customlink	       			     *   //new in project3
 *===========================================================================*/
PUBLIC int req_customlink(
  endpoint_t fs_e,
  ino_t link_parent,
  char *lastc,
  ino_t linked_file
...
/*===========================================================================*
 *				req_stat	       			     *   bit changed and also added some lines 
 original 
...
/*===========================================================================*
 *				req_customunlink	     			     *   //new in project 3
 *===========================================================================*/
PUBLIC int req_customunlink(fs_e, inode_nr, lastc, dmg_type)
endpoint_t fs_e;
ino_t inode_nr;
char *lastc;
int dmg_type;
