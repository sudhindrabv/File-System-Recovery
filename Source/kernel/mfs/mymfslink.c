...
//added FORWARD _PROTOTYPE() for the functions in project3
...
/*===========================================================================*
 *				fs_customlink 				     *  //same as fs_link in mfs/link.c
 *===========================================================================*/
PUBLIC int fs_customlink()
{
 ...
 */
  ...
  char string[MFS_NAME_MAX];
  phys_bytes len;
  int dmg_type; //project3

  dmg_type = (unsigned) fs_m_in.REQ_DMG_TYPE; //project3
  ...
  if(rip->i_sp->s_rd_only) {
  	r = EROFS;
  }  else if(fs_m_in.m_type == REQ_CUSTOMUNLINK) {
...
/*===========================================================================*
 *				damage_unlink_file				     *  //new in projet3
 *===========================================================================*/
